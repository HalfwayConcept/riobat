    <section class="bg-white dark:bg-gray-900 mb-8 p-4 border-l-4">
                ...
                <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto  lg:py-0">
                    ...
                    <div class="w-full bg-white rounded-lg shadow-xl dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                            <h2 class="text-sm font-bold leading-tight tracking-tight text-gray-900 dark:text-white">
                                Veuillez saisir votre email / mot de passe
                            </h2>
                            <form method="POST" class="space-y-4 md:space-y-6" action="index.php?page=login">
                                <div>
                                ...
                                <a class="font-medium text-gray-900 dark:text-white" href="index.php?page=passwordReminder"><br /><br />Mot de passe oublié ?</a>
                            </form>
                            <?php
                            if(!empty($erreur)){
                                ?>
                    ...
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <a href="index.php?page=register">
                                <button class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Créer un compte</button>
                            </a>
                        </div>                    
                </div>
    </div>
