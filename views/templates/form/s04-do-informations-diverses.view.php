...
<section class="mb-8 p-4 border-l-4 border-blue-500 bg-blue-50 dark:bg-gray-800 dark:border-blue-400">
    ...
    <div class="mb-8">
        <div class="flex items-center gap-4 mb-2">
            ...
            <h1 class="text-2xl font-extrabold text-blue-800 dark:text-blue-300"><?= $isPvTheme ? 'Étape 4 : CENTRALE PHOTOVOLTAIQUE' : 'Étape 4 : Opération de construction' ?></h1>
        </div>
        <div class="flex items-center gap-2 text-sm text-gray-500 mb-2">
            <span><?= $isPvTheme ? 'Environnement' : "Situation de l'ouvrage" ?> </span>
            <span class="mx-2">|</span>
            <span><?= $isPvTheme ? 'prévention et protection' : 'Travaux annexes' ?></span>
        </div>
        <hr class="border-blue-200 mb-4">
    </div>
    <!-- Situation de l'ouvrage -->
    <h2 class="text-lg font-bold text-gray-900 mb-4"><?= $isPvTheme ? 'Environnement' : "Situation de l'ouvrage" ?> </h2>
