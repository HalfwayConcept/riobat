    ...
    <div class="max-w-3xl mx-auto py-8 px-4">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
            <div class="flex items-center gap-3 mb-2">
                ...
                <h1 class="text-2xl font-bold text-gray-900">Upload des documents RCD</h1>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-5 border <?= ($has_rcd && $rcd_status === 1) || ($has_annexe && $annexe_status === 1) ? 'border-red-300' : (($has_rcd && $rcd_status === 2) || ($has_annexe && $annexe_status === 2) ? 'border-orange-300' : 'border-gray-200') ?>">
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <!-- Validé : affichage seul, pas d'upload -->
                        ...
                        <!-- Illisible/incorrect ou Partiel : alerte + remarque + re-upload -->
                    ...
                    <!-- Annexe -->
                    <div>
                        <label class="block mb-1 text-sm font-medium text-gray-700">Document Annexe</label>
